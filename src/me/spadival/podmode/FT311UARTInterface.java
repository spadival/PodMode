...
public class FT311UARTInterface extends Activity {
	...
	private static final String ACTION_USB_PERMISSION = "me.spadival.podmode.USB_PERMISSION";
	...
	// public static String ManufacturerString = "mManufacturer=spadival.me";
	// public static String ModelString1 = "mModel=PodMode";
	public static String ManufacturerString = "mManufacturer=FTDI";
	public static String ModelString1 = "mModel=FTDIUARTDemo";

	public static String ModelString2 = "mModel=PodMode Accessory";
	...
	private void SendPacket(int numBytes) {
		try {
			...
			Log.d("PodMode", "PodMode SendPacket exception");
			// e.printStackTrace();
		}
	}
	...
	public final BroadcastReceiver mUsbReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (ACTION_USB_PERMISSION.equals(action)) {
				...
				Log.d("PodMode", "PodMode Closing accessory");
